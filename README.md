...
* **Infrastructure & Deployment:** Docker, Render
* **Third-Party Services:** Open-Meteo REST API
...
* **Backend:** Java, Spring Boot
* **Infrastruktura i Wdrożenie:** Docker, Render
* **Usługi Zewnętrzne:** Open-Meteo REST API
* **Frontend:** HTML, CSS, JavaScript
